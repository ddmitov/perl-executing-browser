...
print "<p align='center'><font size='5'>\n";
print "<a href='http://perl-executing-browser-pseudodomain/scripts/main.pl' target='_blank'>Dynamic Start Page in a New Window</a>\n";
print "</font></p>\n\n";
...
print "<p align='center'><font size='5'>\n";
print "<a href='printpdf://now'>Save as PDF</a>\n";
print "</font></p>\n\n";
