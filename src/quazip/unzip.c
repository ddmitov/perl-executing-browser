...
#include <zlib.h> // PEB Modification following http://stackoverflow.com/questions/4002757/how-to-add-zlib-to-an-existing-qt-installation, original: #include "zlib.h"
