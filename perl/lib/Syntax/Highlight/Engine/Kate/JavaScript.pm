...
Syntax::Highlight::Engine::Kate::JavaScript - a Plugin for JavaScript syntax highlighting
...
Syntax::Highlight::Engine::Kate::JavaScript is a  plugin module that provides syntax highlighting
for JavaScript to the Syntax::Haghlight::Engine::Kate highlighting engine.
