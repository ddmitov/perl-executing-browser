...
The Perl debugger GUI script and the [Syntax::Highlight::Engine::Kate](https://metacpan.org/release/Syntax-Highlight-Engine-Kate) module are located in the ``{PEB_binary_directory}/perl5dbgui`` directory. This folder and all files inside should not be removed or renamed for the proper operation of the Perl debugger GUI.  
