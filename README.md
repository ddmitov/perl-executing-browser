...
The Perl debugger output formatter script and the [Syntax::Highlight::Engine::Kate](https://metacpan.org/release/Syntax-Highlight-Engine-Kate) module are located in ``{PEB_binary_directory}/perl5dbgui/lib`` directory. This relative path is hard-coded in C++ code and must not be changed.  
